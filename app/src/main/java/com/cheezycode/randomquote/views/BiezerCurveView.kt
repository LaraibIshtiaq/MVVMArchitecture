...
class BezierView(context: Context, attrs: AttributeSet? = null) : View(context, attrs) {
    ...
    private val p1 = PointF(0f, 0.95f) // fixed
    private val p2 = PointF(0.45f, 0.6f)
    private val p3 = PointF(0.65f, 0.1f)
    private val p4 = PointF(1.0f, 0.60f) // fixed
